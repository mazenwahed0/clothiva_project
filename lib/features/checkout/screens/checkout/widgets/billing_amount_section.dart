      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            Text(
              '\$${double.parse(CPricingCalculator.calculateShippingCost(subtotal, 'US')).toStringAsFixed(2)}',
        ...
        Row(
          ...
          children: [
            ...
            Text(
              '\$${double.parse(CPricingCalculator.calculateTax(subtotal, 'US')).toStringAsFixed(2)}',
              style: Theme.of(context).textTheme.labelLarge,
            ),
          ],
        ),
        ...
        Row(
          ...
          children: [
            ...
            Text(
              '\$${CPricingCalculator.calculateTotalPrice(subtotal, 'US').toStringAsFixed(2)}',
