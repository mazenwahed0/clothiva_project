...
class CColors {
  ...
  // App theme colors
  static const Color primary = Color(0xFF4b67ff);
  ...
  static const Color primaryBackground =
      Color(0xFFCCFBF1); // Primary Color Background
  static const Color secondaryBackground =
      Color(0xFFFFE4E6); // Secondary Color Background
  ...
  static const Color textPrimary =
      Color(0xFF222A3D); // Theme Nightingale Gray 80
  static const Color textSecondary =
      Color(0xFF4B5363); // Theme Nightingale Gray 60
  static const Color textDarkPrimary =
      Color(0xFFFFFFFF); // Theme Nightingale Gray White
  static const Color textDarkSecondary =
      Color(0xFFD1D5DB); // Theme Nightingale Gray 30
  static const Color textWhite = Colors.white;

  static const Color disabledTextLight =
      Color(0xFFD1D5DB); // Theme Nightingale Gray 30
  static const Color disabledBackgroundLight =
      Color(0xFFF3F4F6); // Theme Nightingale Gray ?

  static const Color disabledTextDark =
      textSecondary; // Theme Nightingale Gray 60
  static const Color disabledBackgroundDark =
      Color(0xFF222A3D); // Theme Nightingale Gray 80
  ...
  static const Color lightContainer =
      Color(0xFFF3F4F6); // Theme Nightingale Gray 10
  static const Color darkContainer =
      Color(0xFF13192B); // Theme Nightingale Gray 90
  static const Color cardBackgroundColor =
      Color(0xFFF7F5F1); // Theme Nightingale Gray 90
  ...
  static const Color iconPrimaryLight =
      Color(0xFF284C76); // Theme Nightingale Gray 80
  static const Color iconSecondaryLight =
      Color(0xFF9CA3AF); // Theme Nightingale Gray 40
  static const Color iconPrimaryDark =
      Color(0xFFFFFFFF); // Theme Nightingale Gray White
  static const Color iconSecondaryDark =
      Color(0xFF9CA3AF); // Theme Nightingale Gray 40
